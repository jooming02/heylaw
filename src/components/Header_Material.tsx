...
const Header_GPT: FunctionComponent = () => {
      ...
      <Row>
        ...
        <Col sm={10} className={styles.heading}>
          <Nav className={styles.rectangleParent} variant="pills">
            ...
            <Nav.Item className={styles.helpChild}>
              <Nav.Link className={styles.helpItem} href="/laywers">Lawyer</Nav.Link>
            </Nav.Item>
            <Nav.Item className={styles.helpActive}>
              <Nav.Link className={styles.helpItemActive} href="/material">Material</Nav.Link>
            </Nav.Item>
            <Nav.Item className={styles.helpChild}>
              <Nav.Link className={styles.helpItem}>Booking</Nav.Link>
            </Nav.Item>
